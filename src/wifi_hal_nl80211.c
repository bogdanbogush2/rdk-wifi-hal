...
void recv_data_frame(wifi_interface_info_t *interface)
{
    ...
    if (eth_hdr->ethertype == host_to_be16(ETH_P_EAPOL)) {
        wifi_hal_info_print("%s:%d: received eapol interface: %s\n", __func__, __LINE__, interface->name);
    }
...
int nl80211_init_primary_interfaces()
{
    ...
    // XXX HARDCODE TEST
    wifi_hal_info_print("%s:%d: ===HARDCODE TEST===\n", __func__, __LINE__);

char set_interface[] = {
  0x24, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x01, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x06, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x08, 0x00, 0x05, 0x00,
  0x03, 0x00, 0x00, 0x00
};
...
char add_link0[] = {
  ...
  0x07, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x94, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x05, 0x00, 0x39, 0x01,
...
char set_reg0[] = {
  ...
  0x09, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
...
char set_wiphy0[] = {
  ...
  0x0f, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x02, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x08, 0x00, 0x26, 0x00,
  0x6c, 0x09, 0x00, 0x00, 0x08, 0x00, 0x27, 0x00,
...
char del_station0[] = {
  0x24, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x10, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x14, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x05, 0x00, 0x39, 0x01,
  0x00, 0x00, 0x00, 0x00
};
...
char qos_map0[] = {
  0x34, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x11, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x68, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x16, 0x00, 0xc7, 0x00,
  0x00, 0x00, 0x02, 0x10, 0x01, 0x01, 0xff, 0xff,
  0x12, 0x16, 0x18, 0x26, 0x28, 0x28, 0x2c, 0x2e,
  0x30, 0x38, 0x00, 0x00
};

    if (send_netlink_raw((unsigned char *)qos_map0, sizeof(qos_map0)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char set_channel0[] = {
  0x34, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x13, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
...
#if 0 // original
char start_ap0[] = {
  ,
  ...
  0x13, 0x00, 0x34, 0x00, 0x42, 0x50, 0x49, 0x2d,
  0x52, 0x44, 0x4b, 0x42, 0x2d, 0x4d, 0x4c, 0x4f,
  0x2d, 0x41, 0x50, 0x00, 0x05, 0x00, 0x39, 0x01,
...
// without socket owner & port over NL
char start_ap0[] = {
  /*0x38, 0x02,*/ 0x30, 0x02,  0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0xf5, 0xe2, 0xcb, 0x68, 0xa5, 0x13, 0x80, 0x00,
  0x0f, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x46, 0x00, 0x0e, 0x00,
  0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff,
...
char set_bss0[] = {
  ...
  0x14, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x19, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x05, 0x00, 0x1c, 0x00,
...
char set_mcast_to_unicast0[] = {
  0x1c, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x15, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x79, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00
};

    if (send_netlink_raw((unsigned char *)set_mcast_to_unicast0, sizeof(set_mcast_to_unicast0)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char deauth0[] = {
  ...
  0x16, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  ...
  0x02, 0x00, 0x00, 0x00
    ...
    if (send_netlink_raw((unsigned char *)deauth0, sizeof(deauth0)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char new_key0[] = {
  0x4c, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x17, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x0b, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x28, 0x00, 0x50, 0x00,
  0x14, 0x00, 0x01, 0x00, 0x2f, 0xa6, 0x3a, 0x9b,
  0x4c, 0x26, 0xa0, 0xf5, 0x8a, 0x35, 0xc7, 0x4d,
  0x3a, 0xa1, 0x74, 0xf1, 0x08, 0x00, 0x03, 0x00,
...
char set_key0[] = {
  ...
  0x18, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x0a, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x18, 0x00, 0x50, 0x00,
...
char new_key01[] = {
  0x4c, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x19, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x0b, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x28, 0x00, 0x50, 0x00,
  0x14, 0x00, 0x01, 0x00, 0xed, 0xc1, 0x11, 0xdd,
  0x78, 0xb2, 0xbc, 0xea, 0xe1, 0x4d, 0xd3, 0x4a,
  0xa8, 0x0f, 0x9d, 0xbb, 0x08, 0x00, 0x03, 0x00,
  0x06, 0xac, 0x0f, 0x00, 0x05, 0x00, 0x02, 0x00,
  0x04, 0x00, 0x00, 0x00, 0x05, 0x00, 0x39, 0x01,
  0x00, 0x00, 0x00, 0x00
};

    if (send_netlink_raw((unsigned char *)new_key01, sizeof(new_key01)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char set_key01[] = {
  0x3c, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x1a, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x0a, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x18, 0x00, 0x50, 0x00,
  ...
  0x00, 0x00, 0x00, 0x00
    ...
    if (send_netlink_raw((unsigned char *)set_key01, sizeof(set_key01)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char set_wiphy01[] = {
  0x54, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x1b, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x02, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x30, 0x00, 0x25, 0x80,
  ...
  0x00, 0x00, 0x00, 0x00
    ...
    if (send_netlink_raw((unsigned char *)set_wiphy01, sizeof(set_wiphy01)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char set_wiphy02[] = {
  0x54, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x1c, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x02, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x30, 0x00, 0x25, 0x80,
  0x2c, 0x00, 0x01, 0x80, 0x05, 0x00, 0x01, 0x00,
  ...
  0x00, 0x00, 0x00, 0x00
    ...
    if (send_netlink_raw((unsigned char *)set_wiphy02, sizeof(set_wiphy02)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char set_wiphy03[] = {
  0x54, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x1d, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x02, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x30, 0x00, 0x25, 0x80,
  0x2c, 0x00, 0x01, 0x80, 0x05, 0x00, 0x01, 0x00,
  ...
  0x00, 0x00, 0x00, 0x00
    ...
    if (send_netlink_raw((unsigned char *)set_wiphy03, sizeof(set_wiphy03)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char set_wiphy04[] = {
  0x54, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x1e, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x02, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x30, 0x00, 0x25, 0x80,
  0x2c, 0x00, 0x01, 0x80, 0x05, 0x00, 0x01, 0x00,
  ...
  0x00, 0x00, 0x00, 0x00
    ...
    if (send_netlink_raw((unsigned char *)set_wiphy04, sizeof(set_wiphy04)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char set_vendor0[] = {
  ...
  0x1f, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x67, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x08, 0x00, 0xc3, 0x00,
  ...
  0x05, 0x00, 0x06, 0x00, 0xfa, 0x00, 0x00, 0x00
    ...
    if (send_netlink_raw((unsigned char *)set_vendor0, sizeof(set_vendor0)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char set_vendor01[] = {
  ...
  0x20, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x67, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x08, 0x00, 0xc3, 0x00,
  0xe7, 0x0c, 0x00, 0x00, 0x08, 0x00, 0xc4, 0x00,
  ...
  0x05, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00
    ...
    if (send_netlink_raw((unsigned char *)set_vendor01, sizeof(set_vendor01)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char set_vendor02[] = {
  ...
  0x21, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x67, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x08, 0x00, 0xc3, 0x00,
  0xe7, 0x0c, 0x00, 0x00, 0x08, 0x00, 0xc4, 0x00,
  ...
  0x05, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00
    ...
    if (send_netlink_raw((unsigned char *)set_vendor02, sizeof(set_vendor02)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char set_vendor03[] = {
  0x38, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x22, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x67, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x08, 0x00, 0xc3, 0x00,
  0xe7, 0x0c, 0x00, 0x00, 0x08, 0x00, 0xc4, 0x00,
  ...
  0x05, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00
    ...
    if (send_netlink_raw((unsigned char *)set_vendor03, sizeof(set_vendor03)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char set_vendor04[] = {
  0x38, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x23, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x67, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x08, 0x00, 0xc3, 0x00,
  0xe7, 0x0c, 0x00, 0x00, 0x08, 0x00, 0xc4, 0x00,
  ...
  0x05, 0x00, 0x07, 0x00, 0x01, 0x00, 0x00, 0x00
    ...
    if (send_netlink_raw((unsigned char *)set_vendor04, sizeof(set_vendor04)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char set_vendor05[] = {
  ...
  0x24, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x67, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x08, 0x00, 0xc3, 0x00,
  0xe7, 0x0c, 0x00, 0x00, 0x08, 0x00, 0xc4, 0x00,
  ...
  0x05, 0x00, 0x06, 0x00, 0x01, 0x00, 0x00, 0x00
    ...
    if (send_netlink_raw((unsigned char *)set_vendor05, sizeof(set_vendor05)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char add_link1[] = {
  0x30, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x25, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x94, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x05, 0x00, 0x39, 0x01,
...
char set_reg1[] = {
  0x1c, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x27, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x1b, 0x00, 0x00, 0x00, 0x07, 0x00, 0x21, 0x00,
  0x55, 0x53, 0x00, 0x00
};
...
char set_wiphy1[] = {
  0x3c, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x2d, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x02, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x08, 0x00, 0x26, 0x00,
...
char set_qos1[] = {
  0x34, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x2e, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x68, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x16, 0x00, 0xc7, 0x00,
  0x00, 0x00, 0x02, 0x10, 0x01, 0x01, 0xff, 0xff,
  0x12, 0x16, 0x18, 0x26, 0x28, 0x28, 0x2c, 0x2e,
...
char set_channel1[] = {
  0x3c, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x2f, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x41, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x08, 0x00, 0x26, 0x00,
  0x3c, 0x14, 0x00, 0x00, 0x08, 0x00, 0x9f, 0x00,
  0x03, 0x00, 0x00, 0x00, 0x08, 0x00, 0xa0, 0x00,
...
char start_ap1[] = {
  /*0x68, 0x02,*/ ,
  ...
  0x00, 0x41, 0x40, 0x00, 0x40, 0xbf, 0x0c, 0xf6,
  0x79, 0x8a, 0x33, 0xea, 0xff, 0x00, 0x00, 0xea,
  0xff, 0x00, 0x20, 0xc0, 0x05, 0x01, 0x2a, 0x00,
  0xfc, 0xff, 0xc3, 0x04, 0x02, 0x2e, 0x2e, 0x2e,
  0xc9, 0x14, 0x00, 0x10, 0x53, 0x01, 0xff, 0x00,
  0x11, 0x22, 0x33, 0x44, 0x00, 0x78, 0x9e, 0x9b,
  0x5f, 0x42, 0x7f, 0x00, 0x00, 0x00, 0xf4, 0x01,
  ...
  0x21, 0x00, 0xff, 0x0f, 0x6c, 0xa2, 0x01, 0xe8,
...
char set_bss1[] = {
  0x4c, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x30, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x19, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x05, 0x00, 0x1c, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x05, 0x00, 0x1d, 0x00,
  0x01, 0x00, 0x00, 0x00, 0x06, 0x00, 0x6d, 0x00,
...
char set_mult1[] = {
  0x1c, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x31, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x79, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00
};

    if (send_netlink_raw((unsigned char *)set_mult1, sizeof(set_mult1)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char new_key1[] = {
  0x4c, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x32, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x0b, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x28, 0x00, 0x50, 0x00,
  0x14, 0x00, 0x01, 0x00, 0x0e, 0x98, 0x0c, 0x14,
  0x74, 0xca, 0x7a, 0xa3, 0x09, 0xae, 0xb7, 0xcc,
  0xa7, 0x29, 0x2e, 0xe2, 0x08, 0x00, 0x03, 0x00,
  0x04, 0xac, 0x0f, 0x00, 0x05, 0x00, 0x02, 0x00,
  0x01, 0x00, 0x00, 0x00, 0x05, 0x00, 0x39, 0x01,
  0x01, 0x00, 0x00, 0x00
};

    if (send_netlink_raw((unsigned char *)new_key1, sizeof(new_key1)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char set_key1[] = {
  0x3c, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x33, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x0a, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x18, 0x00, 0x50, 0x00,
  0x05, 0x00, 0x02, 0x00, 0x01, 0x00, 0x00, 0x00,
  0x04, 0x00, 0x05, 0x00, 0x08, 0x00, 0x08, 0x80,
...
char new_key11[] = {
  0x4c, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x34, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x0b, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x28, 0x00, 0x50, 0x00,
  0x14, 0x00, 0x01, 0x00, 0xbd, 0x11, 0x5c, 0x0e,
  0x1a, 0xdb, 0x5e, 0xc8, 0xd2, 0x5a, 0x75, 0x8e,
  0x4a, 0x0f, 0xf6, 0x51, 0x08, 0x00, 0x03, 0x00,
  0x06, 0xac, 0x0f, 0x00, 0x05, 0x00, 0x02, 0x00,
  0x04, 0x00, 0x00, 0x00, 0x05, 0x00, 0x39, 0x01,
  0x01, 0x00, 0x00, 0x00
};

    if (send_netlink_raw((unsigned char *)new_key11, sizeof(new_key11)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char set_key11[] = {
  0x3c, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x35, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x0a, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x18, 0x00, 0x50, 0x00,
  0x05, 0x00, 0x02, 0x00, 0x04, 0x00, 0x00, 0x00,
  0x04, 0x00, 0x06, 0x00, 0x08, 0x00, 0x08, 0x80,
  ...
  0x01, 0x00, 0x00, 0x00
    ...
    if (send_netlink_raw((unsigned char *)set_key11, sizeof(set_key11)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char set_wiphy11[] = {
  0x54, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x36, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x02, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x30, 0x00, 0x25, 0x80,
  0x2c, 0x00, 0x01, 0x80, 0x05, 0x00, 0x01, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x06, 0x00, 0x02, 0x00,
  ...
  0x01, 0x00, 0x00, 0x00
    ...
    if (send_netlink_raw((unsigned char *)set_wiphy11, sizeof(set_wiphy11)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char set_wiphy12[] = {
  0x54, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x37, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x02, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x30, 0x00, 0x25, 0x80,
  0x2c, 0x00, 0x01, 0x80, 0x05, 0x00, 0x01, 0x00,
  0x01, 0x00, 0x00, 0x00, 0x06, 0x00, 0x02, 0x00,
...
char set_wiphy13[] = {
  0x54, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x38, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x02, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x30, 0x00, 0x25, 0x80,
  0x2c, 0x00, 0x01, 0x80, 0x05, 0x00, 0x01, 0x00,
  0x02, 0x00, 0x00, 0x00, 0x06, 0x00, 0x02, 0x00,
...
char set_wiphy14[] = {
  0x54, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x39, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x02, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x30, 0x00, 0x25, 0x80,
  0x2c, 0x00, 0x01, 0x80, 0x05, 0x00, 0x01, 0x00,
  0x03, 0x00, 0x00, 0x00, 0x06, 0x00, 0x02, 0x00,
...
char set_vendor1[] = {
  0x48, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x3a, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x67, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x08, 0x00, 0xc3, 0x00,
  0xe7, 0x0c, 0x00, 0x00, 0x08, 0x00, 0xc4, 0x00,
  ...
  0x06, 0x00, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00
    ...
    if (send_netlink_raw((unsigned char *)set_vendor1, sizeof(set_vendor1)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char set_vendor11[] = {
  0x48, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x3b, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x67, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x08, 0x00, 0xc3, 0x00,
  0xe7, 0x0c, 0x00, 0x00, 0x08, 0x00, 0xc4, 0x00,
  0xc7, 0x00, 0x00, 0x00, 0x1c, 0x00, 0xc5, 0x80,
  ...
  0x05, 0x00, 0x06, 0x00, 0xfa, 0x00, 0x00, 0x00
    ...
    if (send_netlink_raw((unsigned char *)set_vendor11, sizeof(set_vendor11)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char set_vendor12[] = {
  0x40, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x3c, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x67, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x08, 0x00, 0xc3, 0x00,
  0xe7, 0x0c, 0x00, 0x00, 0x08, 0x00, 0xc4, 0x00,
  0xc5, 0x00, 0x00, 0x00, 0x14, 0x00, 0xc5, 0x80,
  ...
  0x05, 0x00, 0x04, 0x00, 0x01, 0x00, 0x00, 0x00
    ...
    if (send_netlink_raw((unsigned char *)set_vendor12, sizeof(set_vendor12)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char vendor13[] = {
  0x38, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x3d, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x67, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x08, 0x00, 0xc3, 0x00,
  0xe7, 0x0c, 0x00, 0x00, 0x08, 0x00, 0xc4, 0x00,
  0xc8, 0x00, 0x00, 0x00, 0x0c, 0x00, 0xc5, 0x80,
  0x05, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00
    ...
    if (send_netlink_raw((unsigned char *)vendor13, sizeof(vendor13)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char vendor14[] = {
  0x38, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x3e, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x67, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x08, 0x00, 0xc3, 0x00,
  0xe7, 0x0c, 0x00, 0x00, 0x08, 0x00, 0xc4, 0x00,
  0xc9, 0x00, 0x00, 0x00, 0x0c, 0x00, 0xc5, 0x80,
  0x05, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00
    ...
    if (send_netlink_raw((unsigned char *)vendor14, sizeof(vendor14)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char vendor15[] = {
  0x38, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x3f, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x67, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x08, 0x00, 0xc3, 0x00,
  0xe7, 0x0c, 0x00, 0x00, 0x08, 0x00, 0xc4, 0x00,
  0xc4, 0x00, 0x00, 0x00, 0x0c, 0x00, 0xc5, 0x80,
  0x05, 0x00, 0x07, 0x00, 0x01, 0x00, 0x00, 0x00
    ...
    if (send_netlink_raw((unsigned char *)vendor15, sizeof(vendor15)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char vendor16[] = {
  0x58, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x40, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x67, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x08, 0x00, 0xc3, 0x00,
  0xe7, 0x0c, 0x00, 0x00, 0x08, 0x00, 0xc4, 0x00,
  0xce, 0x00, 0x00, 0x00, 0x2c, 0x00, 0xc5, 0x80,
  ...
  0x05, 0x00, 0x06, 0x00, 0x01, 0x00, 0x00, 0x00
    ...
    if (send_netlink_raw((unsigned char *)vendor16, sizeof(vendor16)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char add_link2[] = {
  0x30, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x42, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x94, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x05, 0x00, 0x39, 0x01,
...
char set_reg2[] = {
  0x1c, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x44, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x1b, 0x00, 0x00, 0x00, 0x07, 0x00, 0x21, 0x00,
  0x55, 0x53, 0x00, 0x00
};
...
char set_wiphy2[] = {
  0x3c, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x4a, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x02, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x08, 0x00, 0x26, 0x00,
...
char set_qos_map2[] = {
  0x34, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x4b, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x68, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x16, 0x00, 0xc7, 0x00,
  0x00, 0x00, 0x02, 0x10, 0x01, 0x01, 0xff, 0xff,
  0x12, 0x16, 0x18, 0x26, 0x28, 0x28, 0x2c, 0x2e,
  0x30, 0x38, 0x00, 0x00
    ...
    if (send_netlink_raw((unsigned char *)set_qos_map2, sizeof(set_qos_map2)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char set_channel2[] = {
  0x3c, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x4c, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x41, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x08, 0x00, 0x26, 0x00,
  0xf7, 0x17, 0x00, 0x00, 0x08, 0x00, 0x9f, 0x00,
  0x0d, 0x00, 0x00, 0x00, 0x08, 0x00, 0xa0, 0x00,
...
char start_ap2[] = {
  /*0xa8, 0x02,*/ 0xa0, 0x02, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0xf7, 0xe2, 0xcb, 0x68, 0xa5, 0x13, 0x80, 0x00,
  0x0f, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x43, 0x00, 0x0e, 0x00,
  0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff,
  ...
  ,
  ...
  0x02, 0x00, 0x00, 0x00, 0x13, 0x00, 0x34, 0x00,
  0x42, 0x50, 0x49, 0x2d, 0x52, 0x44, 0x4b, 0x42,
  0x2d, 0x4d, 0x4c, 0x4f, 0x2d, 0x41, 0x50, 0x00,
  ...
  0x00, 0x00, 0x00, 0x00, 0x64, 0x00, 0x78, 0x9e,
  0x9b, 0x5f, 0x07, 0x53, 0x14, 0xcc, 0x00, 0x84,
...
char set_bss2[] = {
  ...
  0x4d, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x19, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x05, 0x00, 0x1c, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x05, 0x00, 0x1d, 0x00,
...
char set_mcast2[] = {
  0x1c, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x4e, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x79, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00
};
...
char set_beacon2[] = {
  0xa8, 0x02, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0xf8, 0xe2, 0xcb, 0x68, 0xa5, 0x13, 0x80, 0x00,
  ...
  0x00, 0x11, 0x22, 0x33, 0x44, 0x02, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x64, 0x00, 0x31, 0x00, 0x00, 0x0f, 0x42, 0x50,
  0x49, 0x2d, 0x52, 0x44, 0x4b, 0x42, 0x2d, 0x4d,
  0x4c, 0x4f, 0x2d, 0x41, 0x50, 0x01, 0x08, 0x8c,
  0x12, 0x98, 0x24, 0xb0, 0x48, 0x60, 0x6c, 0x00,
  0x09, 0x01, 0x0f, 0x00, 0x07, 0x06, 0x55, 0x53,
...
char set_bss21[] = {
  0x44, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x4f, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x19, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x05, 0x00, 0x1c, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x05, 0x00, 0x1d, 0x00,
  0x01, 0x00, 0x00, 0x00, 0x05, 0x00, 0x60, 0x00,
  ...
  0x02, 0x00, 0x00, 0x00
    ...
    if (send_netlink_raw((unsigned char *)set_bss21, sizeof(set_bss21)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char set_mcast5[] = {
  0x1c, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x50, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x79, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00
};

    if (send_netlink_raw((unsigned char *)set_mcast5, sizeof(set_mcast5)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char set_beacon5[] = {
  ...
  ,
  ...
  ,
  ...
  0x03, 0x00, 0x00, 0x00, 0x04, 0x00, 0xcc, 0x00
    ...
    if (send_netlink_raw((unsigned char *)set_beacon5, sizeof(set_beacon5)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char set_bss5[] = {
  0x54, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x51, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x19, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x05, 0x00, 0x1c, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x05, 0x00, 0x1d, 0x00,
  0x01, 0x00, 0x00, 0x00, 0x05, 0x00, 0x1e, 0x00,
  ...
  0x00, 0x00, 0x00, 0x00
    ...
    if (send_netlink_raw((unsigned char *)set_bss5, sizeof(set_bss5)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char set_mcast6[] = {
  0x1c, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x52, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x79, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00
};

    if (send_netlink_raw((unsigned char *)set_mcast6, sizeof(set_mcast6)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char set_beacon6[] = {
  0x7c, 0x02, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0xfa, 0xe2, 0xcb, 0x68, 0xa5, 0x13, 0x80, 0x00,
  0x0e, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x43, 0x00, 0x0e, 0x00,
  0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff,
  0xff, 0xff, 0x00, 0x11, 0x22, 0x33, 0x44, 0x01,
  ...
  0x4c, 0x4f, 0x2d, 0x41, 0x50, 0x01, 0x08, 0x8c,
  0x12, 0x98, 0x24, 0xb0, 0x48, 0x60, 0x6c, 0x00,
  0x31, 0x01, 0x0f, 0x00, 0x30, 0x14, 0x01, 0x00,
  0x00, 0x0f, 0xac, 0x04, 0x01, 0x00, 0x00, 0x0f,
  0xac, 0x04, 0x01, 0x00, 0x00, 0x0f, 0xac, 0x08,
  0xcc, 0x00, 0x0b, 0x05, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x3b, 0x02, 0x80, 0x00, 0x2d, 0x1a, 0xef,
  ...
  0xff, 0x00, 0x20, 0xc0, 0x05, 0x01, 0x2a, 0x00,
  0xfc, 0xff, 0xc3, 0x04, 0x02, 0x2e, 0x2e, 0x2e,
  0xc9, 0x28, 0x00, 0x10, 0x53, 0x01, 0xff, 0x00,
  0x11, 0x22, 0x33, 0x44, 0x00, 0x78, 0x9e, 0x9b,
  0x5f, 0x42, 0x7f, 0x00, 0x00, 0x00, 0x00, 0x10,
  0x86, 0x25, 0xff, 0x00, 0x11, 0x22, 0x33, 0x44,
  0x02, 0x78, 0x9e, 0x9b, 0x5f, 0x42, 0x7f, 0x00,
  0x02, 0x00, 0xf4, 0x01, 0x20, 0xff, 0x20, 0x23,
  ...
  0x01, 0x00, 0x01, 0x00, 0x22, 0x00, 0xff, 0x0f,
  ...
  0x04, 0x00, 0xcc, 0x00
    ...
    if (send_netlink_raw((unsigned char *)set_beacon6, sizeof(set_beacon6)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char set_bss6[] = {
  0x4c, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x53, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x19, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x05, 0x00, 0x1c, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x05, 0x00, 0x1d, 0x00,
  0x01, 0x00, 0x00, 0x00, 0x06, 0x00, 0x6d, 0x00,
  ...
  0x01, 0x00, 0x00, 0x00
    ...
    if (send_netlink_raw((unsigned char *)set_bss6, sizeof(set_bss6)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char set_mcast7[] = {
  0x1c, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x54, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x79, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00
};

    if (send_netlink_raw((unsigned char *)set_mcast7, sizeof(set_mcast7)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char new_key7[] = {
  0x4c, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x55, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x0b, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x28, 0x00, 0x50, 0x00,
  0x14, 0x00, 0x01, 0x00, 0x27, 0x4d, 0xed, 0x41,
  0x82, 0x15, 0x2c, 0xe0, 0x86, 0xe0, 0x30, 0xfe,
  0x32, 0x73, 0x4a, 0x1d, 0x08, 0x00, 0x03, 0x00,
  0x04, 0xac, 0x0f, 0x00, 0x05, 0x00, 0x02, 0x00,
  0x01, 0x00, 0x00, 0x00, 0x05, 0x00, 0x39, 0x01,
  0x02, 0x00, 0x00, 0x00
};

    if (send_netlink_raw((unsigned char *)new_key7, sizeof(new_key7)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char set_key7[] = {
  0x3c, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x56, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x0a, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x18, 0x00, 0x50, 0x00,
  0x05, 0x00, 0x02, 0x00, 0x01, 0x00, 0x00, 0x00,
  0x04, 0x00, 0x05, 0x00, 0x08, 0x00, 0x08, 0x80,
  ...
  0x02, 0x00, 0x00, 0x00
    ...
    if (send_netlink_raw((unsigned char *)set_key7, sizeof(set_key7)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char new_key8[] = {
  0x4c, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x57, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x0b, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x28, 0x00, 0x50, 0x00,
  0x14, 0x00, 0x01, 0x00, 0x01, 0x17, 0x0a, 0x08,
  0x25, 0x2e, 0x46, 0x03, 0x43, 0x7a, 0x0a, 0x19,
  0xc4, 0x83, 0xbb, 0x57, 0x08, 0x00, 0x03, 0x00,
  0x06, 0xac, 0x0f, 0x00, 0x05, 0x00, 0x02, 0x00,
  0x04, 0x00, 0x00, 0x00, 0x05, 0x00, 0x39, 0x01,
  0x02, 0x00, 0x00, 0x00
};

    if (send_netlink_raw((unsigned char *)new_key8, sizeof(new_key8)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char set_key9[] = {
  0x3c, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x58, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x0a, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x18, 0x00, 0x50, 0x00,
  0x05, 0x00, 0x02, 0x00, 0x04, 0x00, 0x00, 0x00,
  0x04, 0x00, 0x06, 0x00, 0x08, 0x00, 0x08, 0x80,
  ...
  0x02, 0x00, 0x00, 0x00
    ...
    if (send_netlink_raw((unsigned char *)set_key9, sizeof(set_key9)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char set_wiphy501[] = {
  0x54, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x59, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x02, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x30, 0x00, 0x25, 0x80,
  0x2c, 0x00, 0x01, 0x80, 0x05, 0x00, 0x01, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x06, 0x00, 0x02, 0x00,
  ...
  0x02, 0x00, 0x00, 0x00
    ...
    if (send_netlink_raw((unsigned char *)set_wiphy501, sizeof(set_wiphy501)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char set_wiphy502[] = {
  0x54, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x5a, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x02, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x30, 0x00, 0x25, 0x80,
  0x2c, 0x00, 0x01, 0x80, 0x05, 0x00, 0x01, 0x00,
  0x01, 0x00, 0x00, 0x00, 0x06, 0x00, 0x02, 0x00,
  ...
  0x02, 0x00, 0x00, 0x00
    ...
    if (send_netlink_raw((unsigned char *)set_wiphy502, sizeof(set_wiphy502)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char set_wiphy503[] = {
  0x54, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x5b, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x02, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x30, 0x00, 0x25, 0x80,
  0x2c, 0x00, 0x01, 0x80, 0x05, 0x00, 0x01, 0x00,
  0x02, 0x00, 0x00, 0x00, 0x06, 0x00, 0x02, 0x00,
  ...
  0x02, 0x00, 0x00, 0x00
    ...
    if (send_netlink_raw((unsigned char *)set_wiphy503, sizeof(set_wiphy503)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char set_wiphy504[] = {
  0x54, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x5c, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x02, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x30, 0x00, 0x25, 0x80,
  0x2c, 0x00, 0x01, 0x80, 0x05, 0x00, 0x01, 0x00,
  0x03, 0x00, 0x00, 0x00, 0x06, 0x00, 0x02, 0x00,
  ...
  0x02, 0x00, 0x00, 0x00
    ...
    if (send_netlink_raw((unsigned char *)set_wiphy504, sizeof(set_wiphy504)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char set_vendor505[] = {
  0x48, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x5d, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x67, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x08, 0x00, 0xc3, 0x00,
  0xe7, 0x0c, 0x00, 0x00, 0x08, 0x00, 0xc4, 0x00,
  0xcc, 0x00, 0x00, 0x00, 0x1c, 0x00, 0xc5, 0x80,
  ...
  0x06, 0x00, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00
    ...
    if (send_netlink_raw((unsigned char *)set_vendor505, sizeof(set_vendor505)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char set_vendor506[] = {
  0x48, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x5e, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x67, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x08, 0x00, 0xc3, 0x00,
  0xe7, 0x0c, 0x00, 0x00, 0x08, 0x00, 0xc4, 0x00,
  0xc7, 0x00, 0x00, 0x00, 0x1c, 0x00, 0xc5, 0x80,
  ...
  0x05, 0x00, 0x06, 0x00, 0xfa, 0x00, 0x00, 0x00
    ...
    if (send_netlink_raw((unsigned char *)set_vendor506, sizeof(set_vendor506)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char set_vendor507[] = {
  0x40, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x5f, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x67, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x08, 0x00, 0xc3, 0x00,
  0xe7, 0x0c, 0x00, 0x00, 0x08, 0x00, 0xc4, 0x00,
  0xc5, 0x00, 0x00, 0x00, 0x14, 0x00, 0xc5, 0x80,
  ...
  0x05, 0x00, 0x04, 0x00, 0x02, 0x00, 0x00, 0x00
    ...
    if (send_netlink_raw((unsigned char *)set_vendor507, sizeof(set_vendor507)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char set_vendor508[] = {
  0x38, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x60, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x67, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x08, 0x00, 0xc3, 0x00,
  0xe7, 0x0c, 0x00, 0x00, 0x08, 0x00, 0xc4, 0x00,
  0xc8, 0x00, 0x00, 0x00, 0x0c, 0x00, 0xc5, 0x80,
  0x05, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00
    ...
    if (send_netlink_raw((unsigned char *)set_vendor508, sizeof(set_vendor508)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char set_vendor509[] = {
  0x38, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x61, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x67, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x08, 0x00, 0xc3, 0x00,
  0xe7, 0x0c, 0x00, 0x00, 0x08, 0x00, 0xc4, 0x00,
  0xc9, 0x00, 0x00, 0x00, 0x0c, 0x00, 0xc5, 0x80,
  0x05, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00
    ...
    if (send_netlink_raw((unsigned char *)set_vendor509, sizeof(set_vendor509)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char set_vendor510[] = {
  0x38, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x62, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x67, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x08, 0x00, 0xc3, 0x00,
  0xe7, 0x0c, 0x00, 0x00, 0x08, 0x00, 0xc4, 0x00,
  0xc4, 0x00, 0x00, 0x00, 0x0c, 0x00, 0xc5, 0x80,
  0x05, 0x00, 0x07, 0x00, 0x01, 0x00, 0x00, 0x00
    ...
    if (send_netlink_raw((unsigned char *)set_vendor510, sizeof(set_vendor510)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char set_vendor511[] = {
  0x58, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x63, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x67, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x08, 0x00, 0xc3, 0x00,
  0xe7, 0x0c, 0x00, 0x00, 0x08, 0x00, 0xc4, 0x00,
  0xce, 0x00, 0x00, 0x00, 0x2c, 0x00, 0xc5, 0x80,
  ...
  0x05, 0x00, 0x06, 0x00, 0x01, 0x00, 0x00, 0x00
    ...
    if (send_netlink_raw((unsigned char *)set_vendor511, sizeof(set_vendor511)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char set_beacon512[] = {
  0xa8, 0x02, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0xfb, 0xe2, 0xcb, 0x68, 0xa5, 0x13, 0x80, 0x00,
  0x0e, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x43, 0x00, 0x0e, 0x00,
  0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff,
  0xff, 0xff, 0x00, 0x11, 0x22, 0x33, 0x44, 0x02,
  ...
  0x58, 0x0a, 0x00, 0x00, 0x04, 0x00, 0xcc, 0x00
    ...
    if (send_netlink_raw((unsigned char *)set_beacon512, sizeof(set_beacon512)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char set_bss513[] = {
  0x44, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x64, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x19, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x05, 0x00, 0x1c, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x05, 0x00, 0x1d, 0x00,
  0x01, 0x00, 0x00, 0x00, 0x05, 0x00, 0x60, 0x00,
  ...
  0x02, 0x00, 0x00, 0x00
    ...
    if (send_netlink_raw((unsigned char *)set_bss513, sizeof(set_bss513)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char set_mcast514[] = {
  0x1c, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x65, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x79, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00
};

    if (send_netlink_raw((unsigned char *)set_mcast514, sizeof(set_mcast514)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char set_mcast515[] = {
  0x60, 0x02, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0xfc, 0xe2, 0xcb, 0x68, 0xa5, 0x13, 0x80, 0x00,
  0x0e, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x46, 0x00, 0x0e, 0x00,
  0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff,
  0xff, 0xff, 0x00, 0x11, 0x22, 0x33, 0x44, 0x00,
  ...
  0x03, 0x00, 0x00, 0x00, 0x04, 0x00, 0xcc, 0x00
    ...
    if (send_netlink_raw((unsigned char *)set_mcast515, sizeof(set_mcast515)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char set_bss516[] = {
  0x54, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x66, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x19, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x05, 0x00, 0x1c, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x05, 0x00, 0x1d, 0x00,
  0x01, 0x00, 0x00, 0x00, 0x05, 0x00, 0x1e, 0x00,
  ...
  0x00, 0x00, 0x00, 0x00
    ...
    if (send_netlink_raw((unsigned char *)set_bss516, sizeof(set_bss516)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char set_mcast517[] = {
  0x1c, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x67, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x79, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00
};

    if (send_netlink_raw((unsigned char *)set_mcast517, sizeof(set_mcast517)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char set_beacon518[] = {
  0x7c, 0x02, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0xfd, 0xe2, 0xcb, 0x68, 0xa5, 0x13, 0x80, 0x00,
  0x0e, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x43, 0x00, 0x0e, 0x00,
  0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff,
  0xff, 0xff, 0x00, 0x11, 0x22, 0x33, 0x44, 0x01,
  ...
  0x04, 0x00, 0xcc, 0x00
    ...
    if (send_netlink_raw((unsigned char *)set_beacon518, sizeof(set_beacon518)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char set_bss519[] = {
  0x4c, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x68, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x19, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x05, 0x00, 0x1c, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x05, 0x00, 0x1d, 0x00,
  0x01, 0x00, 0x00, 0x00, 0x06, 0x00, 0x6d, 0x00,
  ...
  0x01, 0x00, 0x00, 0x00
    ...
    if (send_netlink_raw((unsigned char *)set_bss519, sizeof(set_bss519)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char set_mcast520[] = {
  0x1c, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x69, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x79, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00
};

    if (send_netlink_raw((unsigned char *)set_mcast520, sizeof(set_mcast520)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char set_beacon521[] = {
  0xa8, 0x02, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x00, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x80, 0x00,
  0x0e, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x43, 0x00, 0x0e, 0x00,
  0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff,
  0xff, 0xff, 0x00, 0x11, 0x22, 0x33, 0x44, 0x02,
  ...
  0x58, 0x0a, 0x00, 0x00, 0x04, 0x00, 0xcc, 0x00
    ...
    if (send_netlink_raw((unsigned char *)set_beacon521, sizeof(set_beacon521)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char set_bss522[] = {
  0x44, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0x6e, 0xe3, 0xcb, 0x68, 0xa5, 0x13, 0x00, 0x00,
  0x19, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  0x15, 0x00, 0x00, 0x00, 0x05, 0x00, 0x1c, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x05, 0x00, 0x1d, 0x00,
  0x01, 0x00, 0x00, 0x00, 0x05, 0x00, 0x60, 0x00,
  ...
  0x02, 0x00, 0x00, 0x00
    ...
    if (send_netlink_raw((unsigned char *)set_bss522, sizeof(set_bss522)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char probe_data24[] = {
  ...
  0x1b, 0x7a, 0x00, 0x11, 0x22, 0x33, 0x44, 0x00,
  0x00, 0x11, 0x22, 0x33, 0x44, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x64, 0x00, 0x31, 0x04, 0x00, 0x0f, 0x42, 0x50,
  0x49, 0x2d, 0x52, 0x44, 0x4b, 0x42, 0x2d, 0x4d,
  ...
  0x0f, 0xac, 0x04, 0x01, 0x00, 0x00, 0x0f, 0xac,
  0x08, 0xcc, 0x00, 0x0b, 0x05, 0x00, 0x00, 0x14,
  ...
  0x33, 0x44, 0x01, 0x78, 0x9e, 0x9b, 0x5f, 0x42,
  0x7f, 0x00, 0x01, 0x00, 0x00, 0x10, 0x86, 0x25,
  0xff, 0x00, 0x11, 0x22, 0x33, 0x44, 0x02, 0x78,
  0x9e, 0x9b, 0x5f, 0x42, 0x7f, 0x00, 0x02, 0x00,
...
char probe_data5[] = {
  ...
  0x49, 0x2d, 0x52, 0x44, 0x4b, 0x42, 0x2d, 0x4d,
  0x4c, 0x4f, 0x2d, 0x41, 0x50, 0x01, 0x08, 0x8c,
  0x12, 0x98, 0x24, 0xb0, 0x48, 0x60, 0x6c, 0x30,
  0x14, 0x01, 0x00, 0x00, 0x0f, 0xac, 0x04, 0x01,
  0x00, 0x00, 0x0f, 0xac, 0x04, 0x01, 0x00, 0x00,
  0x0f, 0xac, 0x08, 0xcc, 0x00, 0x0b, 0x05, 0x00,
  0x00, 0x01, 0x00, 0x00, 0x3b, 0x02, 0x80, 0x00,
  ...
  ,
...
char probe_data6[] = {
  ...
  
...
send_frame_cmd:
    ...
    if (WLAN_FC_GET_TYPE(fc) == WLAN_FC_TYPE_MGMT &&
        ...
        wifi_hal_info_print("%s:%d: Replacing probe resp frame, link_id:%d\n", __func__, __LINE__, link_id);
        if (interface->vap_info.vap_index == 0) {
            memcpy(probe_data24, data, 24);
            data = probe_data24;
            data_len = sizeof(probe_data24);
        } else if (interface->vap_info.vap_index == 1) {
            memcpy(probe_data5, data, 24);
            data = probe_data5;
            data_len = sizeof(probe_data5);
        } else
         if (interface->vap_info.vap_index == 16) {
            memcpy(probe_data6, data, 24);
            data = probe_data6;
            data_len = sizeof(probe_data6);
        }
    }
