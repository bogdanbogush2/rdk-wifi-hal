             ...
             void *valid_finish_data)
{
    ...
    uint8_t ifid = if_nametoindex("wifi0");
...
char set_interface0[] = {
  ...
  0xc2, 0x45, 0xef, 0x68, 0xef, 0x76, 0x00, 0x00,
  0x06, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  ifid, 0x00, 0x00, 0x00, 0x08, 0x00, 0x05, 0x00,
  0x03, 0x00, 0x00, 0x00
};

// before new beacon
if (cmd == NL80211_CMD_NEW_BEACON) {
    if (send_netlink_raw((unsigned char *)set_interface0, sizeof(set_interface0)) < 0) {
...
char set_reg[] = {
  ...
  0xc9, 0x45, 0xef, 0x68, 0xef, 0x76, 0x00, 0x00,
...
// before new beacon
if (cmd == NL80211_CMD_NEW_BEACON) {
    if (send_netlink_raw((unsigned char *)set_reg, sizeof(set_reg)) < 0) {
        wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
    } else {
        wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
    }
...
char set_wiphy0[] = {
  0x2c, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0xcf, 0x45, 0xef, 0x68, 0xef, 0x76, 0x00, 0x00,
...
char del_station0[] = {
  0x1c, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0xd0, 0x45, 0xef, 0x68, 0xef, 0x76, 0x00, 0x00,
...
char qos_map0[] = {
  ...
  0xd1, 0x45, 0xef, 0x68, 0xef, 0x76, 0x00, 0x00,
...
char set_channel0[] = {
  0x2c, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0xd3, 0x45, 0xef, 0x68, 0xef, 0x76, 0x00, 0x00,
...
char start_ap0[] = {
  /*0x1c, 0x02,*/ 0x14, 0x02, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0xb6, 0x45, 0xef, 0x68, 0xef, 0x76, 0x80, 0x00,
  ...
  0x4c, 0x4f, 0x2d, 0x41, 0x41, 0x01, 0x08, 0x8c,
  0x12, 0x98, 0x24, 0xb0, 0x48, 0x60, 0x6c, 0x03,
  0x01, 0x01, 0x00, 0x00, 0xdf, 0x00, 0x0f, 0x00,
  ...
  0x00, 0x2b, 0xfc, 0xff, 0xff, 0x02, 0x27, 0x03,
  ...
  0x2d, 0x4d, 0x4c, 0x4f, 0x2d, 0x41, 0x41, 0x00,
  ...
  0x6c, 0x09, 0x00, 0x00, 0x08, 0x00, 0x27, 0x00,
  0x03, 0x00, 0x00, 0x00, 0x0c, 0x00, 0x17, 0x81,
  0x05, 0x00, 0x06, 0x00, 0x03, 0x00, 0x00, 0x00,
  0x0c, 0x00, 0x1b, 0x81, 0x05, 0x00, 0x01, 0x00,
  0x2b, 0x00, 0x00, 0x00, 0x04, 0x00, 0x16, 0x01,
...
char set_bss0[] = {
  ...
  0xd4, 0x45, 0xef, 0x68, 0xef, 0x76, 0x00, 0x00,
  0x19, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  ifid, 0x00, 0x00, 0x00, 0x05, 0x00, 0x1c, 0x00,
...
char set_mcast0[] = {
  0x1c, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0xd5, 0x45, 0xef, 0x68, 0xef, 0x76, 0x00, 0x00,
...
char new_key0[] = {
  ...
  0xd6, 0x45, 0xef, 0x68, 0xef, 0x76, 0x00, 0x00,
  0x0b, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  ifid, 0x00, 0x00, 0x00, 0x28, 0x00, 0x50, 0x00,
  0x14, 0x00, 0x01, 0x00, 0x87, 0xcc, 0x4f, 0x3b,
  0x1b, 0xa0, 0xab, 0xa8, 0x8e, 0x1e, 0x44, 0x10,
  0x58, 0xea, 0xfb, 0x17, 0x08, 0x00, 0x03, 0x00,
...
char set_key0[] = {
  0x34, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0xd7, 0x45, 0xef, 0x68, 0xef, 0x76, 0x00, 0x00,
  0x0a, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  ifid, 0x00, 0x00, 0x00, 0x18, 0x00, 0x50, 0x00,
...
char new_key01[] = {
  0x44, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0xd8, 0x45, 0xef, 0x68, 0xef, 0x76, 0x00, 0x00,
  0x0b, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  ifid, 0x00, 0x00, 0x00, 0x28, 0x00, 0x50, 0x00,
  0x14, 0x00, 0x01, 0x00, 0xc7, 0xd4, 0x44, 0x8c,
  0xca, 0x61, 0x43, 0xa3, 0x31, 0x17, 0x89, 0x9b,
  0x28, 0x93, 0x82, 0x09, 0x08, 0x00, 0x03, 0x00,
...
char set_key01[] = {
  0x34, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0xd9, 0x45, 0xef, 0x68, 0xef, 0x76, 0x00, 0x00,
  0x0a, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  ifid, 0x00, 0x00, 0x00, 0x18, 0x00, 0x50, 0x00,
...
char set_wiphi01[] = {
  0x4c, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0xda, 0x45, 0xef, 0x68, 0xef, 0x76, 0x00, 0x00,
  0x02, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  ifid, 0x00, 0x00, 0x00, 0x30, 0x00, 0x25, 0x80,
  ...
  0x01, 0x00, 0x00, 0x00
    ...
    if (cmd == NL80211_CMD_NEW_BEACON) {
        ...
        if (send_netlink_raw((unsigned char *)set_wiphi01, sizeof(set_wiphi01)) < 0) {
            wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
        } else {
            wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
        }
...
char set_wiphi02[] = {
  0x4c, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0xdb, 0x45, 0xef, 0x68, 0xef, 0x76, 0x00, 0x00,
  0x02, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  ifid, 0x00, 0x00, 0x00, 0x30, 0x00, 0x25, 0x80,
  0x2c, 0x00, 0x01, 0x80, 0x05, 0x00, 0x01, 0x00,
...
char set_wiphi03[] = {
  0x4c, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0xdc, 0x45, 0xef, 0x68, 0xef, 0x76, 0x00, 0x00,
  0x02, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  ifid, 0x00, 0x00, 0x00, 0x30, 0x00, 0x25, 0x80,
  0x2c, 0x00, 0x01, 0x80, 0x05, 0x00, 0x01, 0x00,
...
char set_wiphi04[] = {
  0x4c, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0xdd, 0x45, 0xef, 0x68, 0xef, 0x76, 0x00, 0x00,
  0x02, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  ifid, 0x00, 0x00, 0x00, 0x30, 0x00, 0x25, 0x80,
  0x2c, 0x00, 0x01, 0x80, 0x05, 0x00, 0x01, 0x00,
...
char set_vendor01[] = {
  ...
  0xde, 0x45, 0xef, 0x68, 0xef, 0x76, 0x00, 0x00,
  0x67, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  ifid, 0x00, 0x00, 0x00, 0x08, 0x00, 0xc3, 0x00,
  ...
  0xdf, 0x45, 0xef, 0x68, 0xef, 0x76, 0x00, 0x00,
  0x67, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  ifid, 0x00, 0x00, 0x00, 0x08, 0x00, 0xc3, 0x00,
  0xe7, 0x0c, 0x00, 0x00, 0x08, 0x00, 0xc4, 0x00,
...
char set_vendor03[] = {
  ...
  0xe0, 0x45, 0xef, 0x68, 0xef, 0x76, 0x00, 0x00,
  0x67, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  ifid, 0x00, 0x00, 0x00, 0x08, 0x00, 0xc3, 0x00,
  0xe7, 0x0c, 0x00, 0x00, 0x08, 0x00, 0xc4, 0x00,
...
char set_vendor04[] = {
  0x38, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0xe1, 0x45, 0xef, 0x68, 0xef, 0x76, 0x00, 0x00,
  0x67, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  ifid, 0x00, 0x00, 0x00, 0x08, 0x00, 0xc3, 0x00,
  0xe7, 0x0c, 0x00, 0x00, 0x08, 0x00, 0xc4, 0x00,
...
char set_vendor05[] = {
  0x38, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0xe2, 0x45, 0xef, 0x68, 0xef, 0x76, 0x00, 0x00,
  0x67, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  ifid, 0x00, 0x00, 0x00, 0x08, 0x00, 0xc3, 0x00,
  0xe7, 0x0c, 0x00, 0x00, 0x08, 0x00, 0xc4, 0x00,
...
char set_vendor06[] = {
  ...
  0xe3, 0x45, 0xef, 0x68, 0xef, 0x76, 0x00, 0x00,
  0x67, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  ifid, 0x00, 0x00, 0x00, 0x08, 0x00, 0xc3, 0x00,
  0xe7, 0x0c, 0x00, 0x00, 0x08, 0x00, 0xc4, 0x00,
  ...
  0x05, 0x00, 0x06, 0x00, 0x01, 0x00, 0x00, 0x00
    ...
    if (cmd == NL80211_CMD_NEW_BEACON) {
        ...
        if (send_netlink_raw((unsigned char *)set_vendor06, sizeof(set_vendor06)) < 0) {
            wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
        } else {
            wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
        }
...
char set_beacon0[] = {
  /*0x1c, 0x02,*/ 0x14, 0x02, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0xb7, 0x45, 0xef, 0x68, 0xef, 0x76, 0x80, 0x00,
  ...
  0x0f, 0xac, 0x04, 0x01, 0x00, 0x00, 0x0f, 0xac,
  0x04, 0x01, 0x00, 0x00, 0x0f, 0xac, 0x08, 0xcc,
  0x00, 0x0b, 0x05, 0x00, 0x00, 0x1d, 0x00, 0x00,
  0x3b, 0x02, 0x53, 0x00, 0x2d, 0x1a, 0xef, 0x09,
  0x13, 0xff, 0xff, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  ...
  /*0x04, 0x00, 0xcc, 0x00*/
    ...
    if (cmd == NL80211_CMD_NEW_BEACON || cmd == NL80211_CMD_SET_BEACON) {

        if (send_netlink_raw((unsigned char *)set_beacon0, sizeof(set_beacon0)) < 0) {
            wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
        } else {
            wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
        }
    ...
    char set_bss01[] = {
  0x4c, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0xeb, 0x45, 0xef, 0x68, 0xef, 0x76, 0x00, 0x00,
  0x19, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  ifid, 0x00, 0x00, 0x00, 0x05, 0x00, 0x1c, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x05, 0x00, 0x1d, 0x00,
  0x01, 0x00, 0x00, 0x00, 0x05, 0x00, 0x1e, 0x00,
  ...
  0x0c, 0x18, 0x30, 0x00
    ...
    if (cmd == NL80211_CMD_NEW_BEACON || cmd == NL80211_CMD_SET_BEACON) {
        ...
        if (send_netlink_raw((unsigned char *)set_bss01, sizeof(set_bss01)) < 0) {
            wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
        } else {
            wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
        }
...
char set_mcast01[] = {
  0x1c, 0x00, 0x00, 0x00, 0x19, 0x00, 0x05, 0x00,
  0xec, 0x45, 0xef, 0x68, 0xef, 0x76, 0x00, 0x00,
  0x79, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
  ifid, 0x00, 0x00, 0x00
};
    ...
    if (cmd == NL80211_CMD_NEW_BEACON || cmd == NL80211_CMD_SET_BEACON) {
        ...
        if (send_netlink_raw((unsigned char *)set_mcast01, sizeof(set_mcast01)) < 0) {
            wifi_hal_error_print("%s:%d: Failed to set\n", __func__, __LINE__);
        } else {
            wifi_hal_info_print("%s:%d: Successfully set\n", __func__, __LINE__);
        }
...
char probe_data24[] = {
  0x50, 0x00, 0x00, 0x00, 0x58, 0x96, 0x30, 0x3f,
  0xce, 0xae, 0x00, 0x11, 0x22, 0x33, 0x44, 0x00,
  0x00, 0x11, 0x22, 0x33, 0x44, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x64, 0x00, 0x31, 0x04, 0x00, 0x0f, 0x42, 0x50,
  0x49, 0x2d, 0x52, 0x44, 0x4b, 0x42, 0x2d, 0x4d,
  ...
  0xf4, 0x3f, 0x00, 0x2b, 0xfc, 0xff, 0xff, 0x02,
  0x27, 0x03, 0xff, 0x0e, 0x26, 0x01, 0x00, 0xa9,
  0x03, 0x20, 0xa9, 0x03, 0x40, 0x75, 0x03, 0x60,
  0x75, 0x03, 0xff, 0x0f, 0x6c, 0xa2, 0x01, 0xe8,
